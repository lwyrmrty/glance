...
import { FormSubmissionsPage } from '@/app/form-submissions/FormSubmissionsPage'

export default async function FormSubmissionsRoute({ params }: { params: Promise<{ workspaceId: string }> }) {
