...
type SubTab = 'accounts' | 'form-submissions' | 'poll-submissions'

export default function UserDataPage({ workspaceName, workspaceId, glances }: UserDataPageProps) {
            ...
            <div className="textside">
              <div className="innerhero">
                ...
                <div className="inner-hero-nav">
                  <a
                    href="#"
                    className={`innerhero-nav-link w-inline-block${activeSubTab === 'accounts' ? ' active' : ''}`}
                    onClick={(e) => { e.preventDefault(); setActiveSubTab('accounts') }}
                  >
                    <div>Accounts</div>
                  </a>
                  <a
                    href="#"
                    className={`innerhero-nav-link w-inline-block${activeSubTab === 'form-submissions' ? ' active' : ''}`}
                    onClick={(e) => { e.preventDefault(); setActiveSubTab('form-submissions') }}
                  >
                    <div>Form Submissions</div>
                  </a>
                  <a
                    href="#"
                    className={`innerhero-nav-link w-inline-block${activeSubTab === 'poll-submissions' ? ' active' : ''}`}
                    onClick={(e) => { e.preventDefault(); setActiveSubTab('poll-submissions') }}
                  >
                    <div>Poll Submissions</div>
                  </a>
                </div>
              </div>
              ...
              {activeSubTab === 'poll-submissions' && (
                <div className="contentblock">
                  <div style={{ padding: '40px 20px', textAlign: 'center', color: '#999', fontSize: '14px' }}>
                    Poll submissions will appear here.
                  </div>
                </div>
              )}
            </div>
