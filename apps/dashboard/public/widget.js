...
function G(l,e,s,p,c,widgetEl){
  ...
  mcBtn.addEventListener("click",async()=>{
    ...
    try{
      ...
      localStorage.setItem("glance_session_"+p,data.token);if(data.user&&data.user.id)_glanceUserId=data.user.id;
      if(widgetEl)widgetEl.renderActiveTab()
...
var _glanceEvents=[];var _glanceWidgetId=null;var _glanceApiBase='';var _glanceUserId=null;
