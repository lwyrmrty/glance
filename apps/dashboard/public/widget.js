...
.glanceprompts-dismiss {
  width: 25px;
  height: 25px;
  padding-top: 1px;
  border: 1px solid color-mix(in srgb, var(--vcs-purple) 10%, transparent);
  ...
  color: color-mix(in srgb, var(--vcs-purple) 50%, transparent);
  font-size: 19px;
  line-height: 1;
}
.glanceprompts-dismiss:hover { background: #fff; color: var(--vcs-purple); }
.glanceprompts {
  grid-column-gap: 5px;
  grid-row-gap: 5px;
  flex-flow: column;
...
.glancebutton {
  ...
  font-family: inherit;
  transition: transform 0.15s ease, box-shadow 0.15s ease, opacity 230ms ease, color 230ms ease, background-color 230ms ease;
}
...
.glancebutton.wide {
  ...
  font-size: 15px;
  display: flex;
  transition: opacity 230ms ease, color 230ms ease, background-color 230ms ease;
}
...
.glancebutton:not(.open-state) {
  opacity: 1;
  transition: opacity 230ms ease, color 230ms ease, background-color 230ms ease !important;
}
.glancebutton.open-state {
  background-color: #000 !important;
  color: #fff;
  box-shadow: 0 4px 20px rgba(0,0,0,0.2);
  position: relative;
  transition: color 230ms ease, background-color 230ms ease !important;
}
.glancebutton.open-state::before {
  content: '';
  position: absolute;
  inset: 0;
...
.glancebutton.open-state:hover::before {
  opacity: 1;
}
.glancebutton.open-state svg {
  position: relative;
  z-index: 1;
}
...
.contenttype { flex-flow: column; display: flex; }
.content-stack-link {
  grid-column-gap: 10px;
  grid-row-gap: 10px;
  color: #000;
...
.content-stack-link:hover { border-color: var(--vcs-purple); background-color: #107e7f0a; }
.content-stack-image {
  aspect-ratio: 16 / 9;
  border: 1.5px solid #066f3a1a;
  border-radius: 10px;
...
.content-stack-block { padding: 5px 10px 10px; }
.content-stack-header { font-size: 17px; font-weight: 500; line-height: 1.2em; }
.content-stack-subheader { opacity: .6; margin-top: 3px; font-size: 15px; line-height: 1.4em; }
.content-quote {
...
.content-quote-wrapper { width: 100%; font-size: 16px; line-height: 1.4em; }
.text-block-2 { font-size: 16px; font-weight: 400; line-height: 26px; }
.contentquote-row {
  grid-column-gap: 7px;
  grid-row-gap: 7px;
  justify-content: flex-start;
...
.content-quote-name { margin-top: 5px; font-size: 16px; font-weight: 500; line-height: 1.2em; }
.content-quote-title { opacity: .6; margin-top: 1px; font-size: 14px; line-height: 1.4em; }
.content-quote-image {
...
.content-card-theme.contenttype .content-row-link,
.content-card-theme.contenttype .content-stack-link,
.content-card-theme.contenttype .content-quote {
  background-color: var(--vcs-purple);
  border-color: var(--vcs-purple);
  color: #fff;
}
.content-card-theme.contenttype .content-row-subheader,
.content-card-theme.contenttype .content-stack-subheader,
.content-card-theme.contenttype .content-quote-title {
  color: rgba(255,255,255,0.85);
}
.content-card-theme.contenttype .galleryimage {
  border-color: var(--vcs-purple);
}
.content-card-black.contenttype .content-row-link,
.content-card-black.contenttype .content-stack-link,
.content-card-black.contenttype .content-quote {
  background-color: #111;
  border-color: #111;
  color: #fff;
}
.content-card-black.contenttype .content-row-subheader,
.content-card-black.contenttype .content-stack-subheader,
.content-card-black.contenttype .content-quote-title {
  color: rgba(255,255,255,0.85);
}
.content-card-black.contenttype .galleryimage {
  border-color: #111;
}
.imageoverlay {
  opacity: 0;
